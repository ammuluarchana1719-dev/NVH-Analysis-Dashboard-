...
📂 Repository Contents
NVH analysis.ipdy: Synthetic dataset used for analysisand Python script for generating the synthetic NVH dataset..
NVH Analysis.pbix: Power BI dashboard file containing the NVH analysis.
README.md: This documentation file.
NVH-analysis .pdf: Task description document outlining requirements.
